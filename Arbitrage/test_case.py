...
if __name__ == '__main__':
    ...
    suite.addTest(data_manager.TestCase_data_manager("test_get_all_datas"))
    suite.addTest(data_manager.TestCase_data_manager("test_get_file_datas"))
    suite.addTest(data_manager.TestCase_data_manager("test_get_data_file_names"))
    suite.addTest(data_manager.TestCase_data_manager("test_get_file_slice_times"))
    suite.addTest(data_manager.TestCase_data_manager("test_get_file_slice_datas"))
