...
#    def __init__(this, log_queue):
#        threading.Thread.__init__(this)
#        this.log_queue = log_queue

#    def run(this):
#        while True:
#            if not this.log_queue.empty():
#                file_name, content = this.log_queue.get()
#                HandleLog(file_name, content)
#            #else:
#                this.log_queue.task_done()
...
def HandleLog(file_name, content):
  ...
  #      print (path,"==",colorama.Style,"==",content)
...
if __name__ == '__main__':
    WriteLog("tstfile","13341")
    WriteLog("tstfile", "2313341")